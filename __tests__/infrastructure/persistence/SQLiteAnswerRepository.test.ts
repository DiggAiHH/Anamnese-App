...
describe('SQLiteAnswerRepository', () => {
  ...
  it('getAnswersMap() decrypts values and returns questionId -> value map', async () => {
    ...
    const out = await repo.getAnswersMap('33333333-3333-3333-3333-333333333333', validKey);
  ...
  it('getAnswersMap() returns empty map when decryption key is invalid length', async () => {
    ...
    const out = await repo.getAnswersMap('33333333-3333-3333-3333-333333333333', 'short');
