...
|-------|---------|-----------|--------|
| 1 | Arzt/Patient Dual-Flow | P0 | ⏳ TODO |
| 2 | i18n Vervollständigung (19 Sprachen) | P0 | ⏳ TODO |
| 3 | Datenschutz UX (Required/Optional Erklärungen) | P1 | ⏳ TODO |
| 4 | UI Labels Audit + i18n Keys | P1 | ⏳ TODO |
| 5 | Output-Box (Antwort-Übersicht + Rücksprung) | P1 | ⏳ TODO |
| 6 | Calculator Stabilität (Windows Crash Fix) | P0 | ⏳ TODO |
| 7 | Laborbericht Upload + Auto-Werte | P2 | ⏳ TODO |
| 8 | Test-Seed-Daten | P2 | ⏳ TODO |
| 9 | Single-Question Universe (Fragenstruktur) | P3 | ⏳ TODO |
| 10 | Geburtsdatum-Eingabe Fix | P1 | ⏳ TODO |
